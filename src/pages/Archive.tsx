  ...
  const loadStrips = async () => {
    try {
      ...
      const fallbackStrips = [
        { id: "local-001", title: "Bienvenido a Porteria", image_url: "/Porteria/strips/strip-001.png", media_type: 'image' as const, publish_date: "2025-12-10" },
      ];
      setStrips(fallbackStrips);
    } finally {
      setLoading(false);
    }
  };
